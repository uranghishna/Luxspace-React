...
export default function ProductDetails(){
  ...
  <div className="flex flex-wrap my-4 md:my-12">
    ...
    <div className="flex-1 px-4 md:p-6">
      ...
      <a href="cart.html" className="transition-all duration-200 bg-pink-400 text-black focus:bg-black focus:text-pink-400 rounded-full px-8 py-3 mt-4 inline-flex"><svg className="fill-current mr-3" width={26} height={24} viewBox="0 0 26 24">
