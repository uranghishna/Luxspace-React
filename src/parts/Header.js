  ...
  <div className="container mx-auto py-5">
    <div className="flex flex-stretch items-center">
      <div className="w-56 items-center flex">
        <img src="images/content/logo.png" alt="Lux space | Fulfill your house with beautiful furniture" />
      </div>
      ...
      <div className="w-auto">
        <ul className="items-center flex">
          ...
          <li className="ml-6">
            <Link id="header-cart" className="flex items-center justify-center w-8 h-8 text-black md:text-white" to="/cart">
